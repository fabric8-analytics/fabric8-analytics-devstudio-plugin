 ...
 *******************************************************************************/
package com.redhat.fabric8analytics.eclipse.lsp.core.tests;
...
public class Fabric8AnalyticsStreamConnectionProviderTest {
	...
	public void setup() throws StorageException {
		Fabric8AnalysisLSPPreferences.getInstance().setLSPServerEnabled(true);
	...
	public void start_analysesDisabled() throws IOException {
		Fabric8AnalysisLSPPreferences.getInstance().setLSPServerEnabled(false);
		provider.start();
	}
