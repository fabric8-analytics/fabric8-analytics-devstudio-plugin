...
public class Fabric8AnalyticsStreamConnectionProviderTest {
	...
	public void setup() {
		...
		provider = new Fabric8AnalyticsStreamConnectionProvider(tokenCheck);
	}
	...
	public void createProcessBuilder() {
		...
		assertThat(params, hasEntry(Fabric8AnalyticsStreamConnectionProvider.RECOMMENDER_API_URL, RecommenderAPIProvider.RECOMMENDER_API_ANALYZER_URL));
	}
