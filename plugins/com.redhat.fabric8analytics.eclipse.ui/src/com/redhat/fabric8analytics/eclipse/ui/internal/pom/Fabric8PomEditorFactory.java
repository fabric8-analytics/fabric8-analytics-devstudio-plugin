...
package com.redhat.fabric8analytics.eclipse.ui.internal.pom;
...
public class Fabric8PomEditorFactory extends MavenPomEditorPageFactory {
	...
	public void addPages(MavenPomEditor pomEditor) {
		...
		try {
			...
			Fabric8AnalysisUIActivator.getDefault().getLog().log(new Status(IStatus.ERROR, Fabric8AnalysisUIActivator.getDefault().getBundle().getSymbolicName(), e.getLocalizedMessage(), e));
