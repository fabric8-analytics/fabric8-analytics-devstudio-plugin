...
public class GetAnalyticsAuthDataJob extends Job {
	...
	protected IStatus run(IProgressMonitor progressMonitor) {
		...
		try {
			...
			Fabric8AnalysisUIActivator.getDefault().logError("Error while retrieving stored data", e);
			return new Status(IStatus.ERROR, Fabric8AnalysisUIActivator.PLUGIN_ID,
